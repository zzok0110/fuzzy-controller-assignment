...
%% Simulation setup
% Time
simulationTime_total = 10;           % in seconds *------* YOU CAN CHANGE THIS
...
for timeStep = 1:timeSteps_total
    ...
    if timeStep == 2/stepSize_time
        voltage_left  = -6;
        voltage_right = 6;

    end

    if timeStep == 3/stepSize_time
        voltage_left  = 6;
        voltage_right = 6;

    end
    if timeStep == 4/stepSize_time
        voltage_left  = 6;
        voltage_right = -6;

    end
    if timeStep == 5/stepSize_time
        voltage_left  = 6;
        voltage_right = 6;
